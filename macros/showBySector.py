...
def main():
    ...
    if "rec" in branch_list:
        df = df.Define("SF_PCAL", "rec.E_PCAL / rec.p")
        df = df.Define("SF_ECIN", "rec.E_ECIN / rec.p")
        ...
        # show_by_sector("electron", df_ele, "ECAL", y_branch="SF", x_branch="rec.p", sector_branch="rec.sector",
        #                 x_range=(2, 7), y_range=(0.1, 0.35), x_bins=100, y_bins=100)

        show_by_sector("electron", df_ele, "ECAL", y_branch="SF_PCAL", x_branch="SF_ECIN", sector_branch="rec.sector",
                       x_range=(0, 0.3), y_range=(0, 0.3), x_bins=100, y_bins=100, log_scale=True)
